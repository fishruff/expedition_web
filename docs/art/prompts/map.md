...
Карта — `island-map.png`, 320×240: она предмет, а не интерфейс, поэтому сетка плотная.
Самый крупный ассет проекта и единственный, где генератору можно дать волю: мелкие
неточности на такой площади не читаются.
