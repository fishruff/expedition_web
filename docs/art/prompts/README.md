...
[`../reference/style-sheet.png`](../reference/style-sheet.png) — нарисованные часы в
четырёхкратном увеличении и вся палитра плашками. Одна приложенная картинка держит стиль
...
Он уже вставлен в каждый промпт, отдельно собирать не надо. Привожу целиком, чтобы было
понятно, что менять при желании, — меняется только первая строка с предметом.
