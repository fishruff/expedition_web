...
`watch.png`, 112×103. Ведут в хронометр. **Нарисован и стоит в проекте**, промпт оставлен на случай
перерисовки: именно с этого предмета снят эталон стиля.

## Промпт

```
An antique brass pocket watch, the round lid hinged open to the left, the enamel dial
facing the viewer, thin dark hands, a short chain ring on top.
...
- цепочка не сливается с корпусом;
- циферблат светлее всего в предмете — он и держит внимание.

## Куда класть готовое

В [`incoming/`](../../../../incoming/) под именем `watch.png`.
