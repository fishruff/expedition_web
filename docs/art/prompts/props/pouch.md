...
```
A small drawstring leather pouch, tied at the neck, slightly full.
...
- горловина стянута шнурком — по ней мешочек и узнают;
- кожа тёмная, чтобы не спорить с монетами рядом.
...
В [`incoming/`](../../../../incoming/) под именем `pouch.png`.
