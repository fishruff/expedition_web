...
```
A small pile of five worn gold coins, some flat and one leaning.
...
- одна монета стоит на ребре — иначе горсть читается пятном;
- золото тусклое: блестящее выбьется из всей сцены.
...
В [`incoming/`](../../../../incoming/) под именем `coins.png`.
