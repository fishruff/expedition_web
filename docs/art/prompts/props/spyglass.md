...
`spyglass.png`, около 128×48. Декор.
...
```
A collapsed brass spyglass with a worn leather grip in the middle, oriented horizontally.
...
- труба сложена: раздвинутая не поместится по ширине;
- кожаная обмотка посередине — то, чем она отличается от ключа по силуэту.
...
В [`incoming/`](../../../../incoming/) под именем `spyglass.png`.
