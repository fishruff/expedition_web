...
```
A worn hunting knife in a leather sheath, oriented horizontally, handle to the left.
...
- клинок наполовину в ножнах — так предмет читается ножом, а не полосой;
- рукоять слева: справа она встанет в спор с трубой.
...
В [`incoming/`](../../../../incoming/) под именем `knife.png`.
