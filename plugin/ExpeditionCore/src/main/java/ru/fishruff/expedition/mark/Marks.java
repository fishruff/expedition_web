 ...
 *
 * Ставит метку только оператор командой. Насколько это защита — зависит от того,
 * насколько защищён сам оператор: при `online-mode=false` им становится любой,
 * кто зашёл под чужим ником. Здесь это сказано вслух, потому что комментарий,
 * обещающий безопасность, которой нет, хуже отсутствия комментария.
 */
